// Package config loads User Profile settings from the environment.
package config
...
const ServiceName = "user-profile-service"

// ConsumerGroup consumes auth.events.
const ConsumerGroup = "user-profile"
