// Command library runs the Library Service.
//
//	library          serve the HTTP API
//	library migrate  apply database migrations and exit
package main
...
import (
	...
	"github.com/tehrelt/icyre/services/library/internal/adapters/catalog"
	httpadapter "github.com/tehrelt/icyre/services/library/internal/adapters/http"
	kafkaadapter "github.com/tehrelt/icyre/services/library/internal/adapters/kafka"
	pgadapter "github.com/tehrelt/icyre/services/library/internal/adapters/postgres"
	"github.com/tehrelt/icyre/services/library/internal/application"
	"github.com/tehrelt/icyre/services/library/internal/config"
)
...
func run(args []string) error {
	...
	// Events go to library.outbox in the transaction of each change; the
